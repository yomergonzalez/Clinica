$(function () {
 ...
 // DATA TABLE DE CUENTAS
        var table = $('#table_estudio').DataTable({
            'autoWidth': false,
            'select': true,
            ...
            'responsive': true,
            'ajax': {
                'url': base_url + 'configuration/get_estudios',
                'type': 'POST'
            },
...
$('#table_estudio').on('click','.delete_item' , function(){

        $.confirm({
            text: "Borrar Elemento?",
            confirm: function() {
                $.ajax({
                url: base_url + "configuration/delete_estudio",
                type: "post",
                dataType: "json",
                data: 'id='+item.id,
                 beforeSend : function() {
...
$('#table_estudio').on('click','.edit_item' , function(){
   
            $.ajax({
                url: base_url + "configuration/get_estudio",
                type: "post",
                dataType: "json",
                data: 'id='+item.id,
                 beforeSend : function() {
...
$("#submit").on("click", function(e){
        ...
        if (empty){
            ...
            $.ajax({
                url: base_url + "configuration/add_estudio",
                type: "post",
                dataType: "json",
                data: data,
                 beforeSend: function() {
                ...
                .done(function(data){
                    document.getElementById("form_add_estudio").reset();
                    $('#modal_add_estudio').modal('hide')
...
$("#edit").on("click", function(e){
        ...
        if (empty){
            ...
            $.ajax({
                url: base_url + "configuration/edit_estudio",
                type: "post",
                dataType: "json",
                ...
                .done(function(data){
                    $('#modal_edit_estudio').modal('hide')
                    toastr.success('Editado', 'Listo');
                     table.ajax.reload()
                    document.getElementById("form_edit_estudio").reset();
